...
const DEFAULT_ROWS: TodaysSignalRow[] = [
  { id: "housing", label: "Housing Momentum", status: "↑ Rising", tone: "up", icon: "home" },
  { id: "ai", label: "AI Infrastructure", status: "↑ Accelerating", tone: "up", icon: "cpu" },
  { id: "inflation", label: "Inflation", status: "↓ Cooling", tone: "cool", icon: "chart" },
  { id: "china", label: "Chinese Demand", status: "↑ Improving", tone: "up", icon: "globe" },
];
