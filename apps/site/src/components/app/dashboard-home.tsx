  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        const res = await fetch("/api/home/briefing", { cache: "no-store" });
        ...
        // Briefing is optional on the legacy dashboard shell.
          ...
          <div className="app-signal-card shrink-0">
            ...
            {briefingLoading ? (
              ...
              <>
                ...
                <p className="text-sm text-slate-500">Pulling live briefing</p>
