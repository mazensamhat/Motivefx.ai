...
const styles = StyleSheet.create({
  ...
  switch: { color: colors.accent, textAlign: "center", marginTop: 16, fontSize: 15 },
  error: { color: colors.red, marginBottom: 8, fontSize: 15 },
  ...
  buildTag: { marginTop: 10, fontSize: 12, color: colors.dim, textAlign: "center", fontFamily: Platform.OS === "ios" ? "Menlo" : "monospace" },
});
